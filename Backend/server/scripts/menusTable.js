...
db.serialize(() => {
  ...
  db.run(`INSERT INTO menus (restaurant_id, ordre, name, namesuite, price) VALUES
    ...
    (1, 'PLATS', 'Parmentier de queue de boeuf', 'À la truffe noire sur sa purée de panais', 35),
    ...
    (1, 'DESSERTS', 'Mousse au chocolat', 'Au piment d''espelette et à la truffe noire', 23),
    (2, 'ENTREES', 'Ravioles de foie gras', 'Accompagnées de leur crème à la truffe', 25),
    (2, 'ENTREES', 'Caviar osciètre', 'Sur blini à la farine de blé noir', 35),
    (2, 'ENTREES', 'Homard et espuma de potiron', 'Mariné aux zestes d''orange', 20),
    ...
    (2, 'DESSERTS', 'Baba au rhum revisité', 'Avec son coulis de citron', 22),
    ...
    (3, 'DESSERTS', 'Fondant au chocolat', 'Revisité', 22),
    ...
    (4, 'DESSERTS', 'Crème brûlée', 'Revisitée', 22),
    (4, 'DESSERTS', 'Tiramisu', 'À la noisette', 23)
  `);

  console.log("Table menus et données ajoutées avec succès");
});
